...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-12 space-y-4 text-ink/80 leading-relaxed">
      ...
      <p>
        We are not responsible for the products sold, shipped, or fulfilled by
        Amazon or third-party sellers on Amazon. Any purchase you make is a
        transaction between you and Amazon (or the relevant seller), subject to
